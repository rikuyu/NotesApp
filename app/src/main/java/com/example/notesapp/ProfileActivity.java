    ...
    private void setUserProfileUrl(Uri uri){
        ...
        user.updateProfile(req)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ProfileActivity.this, "更新失敗", Toast.LENGTH_SHORT).show();;
                    }
                });
    }
        ...
        firebaseUser.updateProfile(request)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(ProfileActivity.this, "プロフィール更新成功", Toast.LENGTH_SHORT).show();
                        ;
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        view.setEnabled(true);
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(ProfileActivity.this, "プロフィール更新失敗", Toast.LENGTH_SHORT).show();
                        ;
                    }
                });
    }
